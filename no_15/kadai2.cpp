...
void display(void)
{
    ...
    glScaled(left_eye_position.width / 2, left_eye_position.height / 2, 20.0);                             // 拡大縮小
    ...
    glPushMatrix();                                                                                        // 行列一時保存
    glTranslated(left_eye_center.x - imageSize.width / 2, imageSize.height / 2 - left_eye_center.y, 30.0); // 中心座標
    glScaled(left_eye_position.width / 1.5, left_eye_position.height / 2, 10.0);                           // 拡大縮小
    glutSolidSphere(1.0, 100, 100);                                                                        // 球の配置
    glPopMatrix();                                                                                         // 行列復帰
    ...
    glScaled(right_eye_position.width / 2, right_eye_position.height / 2, 20.0);                             // 拡大縮小
    glutSolidSphere(1.0, 100, 100);                                                                          // 球の配置
    glPopMatrix();
    ...
    glPushMatrix();                                                                                          // 行列一時保存
    glTranslated(right_eye_center.x - imageSize.width / 2, imageSize.height / 2 - right_eye_center.y, 30.0); // 中心座標
    glScaled(right_eye_position.width / 1.5, right_eye_position.height / 2, 10.0);                             // 拡大縮小
    glutSolidSphere(1.0, 100, 100);                                                                          // 球の配置
    glPopMatrix();
    // 行列復帰
    // ------------------口------------------
